...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function _updateTotalPrice() {
    _updateTotalPrice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
  ...
  document.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(clickEvent) {
      var target, productContainer, productID, data, response;
