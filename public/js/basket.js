...
/* harmony export */   updateTotalPriceHtml: () => (/* binding */ updateTotalPriceHtml)
/* harmony export */ });
...
function updateTotalPrice(_x) {
  return _updateTotalPrice.apply(this, arguments);
}
function _updateTotalPrice() {
  _updateTotalPrice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var formData, action, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          action = !data["amount"] ? "remove" : "add";
          formData.append("_token", csrf);
          response = null;
          _context.prev = 6;
          _context.next = 9;
          return fetch("/basket/".concat(action), {
            method: "POST",
            body: formData,
...
function updateCarts(productID, amount, action) {
  var typeSelector = "[data-js=\"product\"]";
  var IDSelector = "[data-id=\"".concat(productID, "\"]");
  document.querySelectorAll(typeSelector + IDSelector).forEach(function (e) {
    var amountInput = e.querySelector(".count input");
    if (amount) amountInput.value = amount;
    var inCart = e.querySelector(".cart.in");
    var notInCart = e.querySelector(".cart.not-in");
    if (action === "add") {
...
document.addEventListener("DOMContentLoaded", function () {
  var emptyBasketNode = document.querySelector(".no-product");
  var notEmptyBasketNode = document.querySelector(".has-products");
  var successNode = document.querySelector(".basket-content .state.success");
  var errorNode = document.querySelector(".basket-content .state.error");
  var orderFormNode = document.querySelector(".order-form");
  document.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(clickEvent) {
      var target, productContainer, someProductCart;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            target = clickEvent.target.closest("[data-js=removable]");
            if (target) {
              _context.next = 3;
              break;
            }
          ...
          case 3:
            ...
            productContainer = target.closest("[data-js=product-container]");
            if (productContainer) {
              _context.next = 8;
              break;
            }
          ...
          case 8:
            ...
            someProductCart = document.querySelector("#basket [data-js=product]");
  ...
  orderFormNode.addEventListener("submit", /*#__PURE__*/function () {
